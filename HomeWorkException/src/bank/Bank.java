...
public class Bank {
    public static void main(String[] args) {
        /** Первый вызов для MaxBalanceExceededException */
        BankAccount account1 = new BankAccount(1000, 500);
        BankAccount account2 = new BankAccount(2000, 1000);

        Thread thread1 = new Thread(() -> {
            try {
                account1.deposit(500); // вызовет ошибку MaxBalanceExceededException
    ...
    /** Второй вызов для InsufficientFundsException закомментирован */
